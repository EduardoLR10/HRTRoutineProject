        ...
        <Subsection title="Medidas de Eliminação">
          ...
          <List>
            ...
            <LItem>
              ...
              Portanto, é recomendada a administração em <Italic>bolus</Italic>{' '}
              de 1-2 mEq/Kg de bicarbonato de sódio (NaHCO3) a 8,4%, seguida por
              infusão contínua de 150 mEq de NaHCO3 em 1 litro de soro glicosado
              a 5% (SG 5%) (manter infusão entre 200-250 ml/h).
            </LItem>
            <LItem>
