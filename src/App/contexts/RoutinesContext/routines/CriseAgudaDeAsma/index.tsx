  ...
  return (
    ...
    >
      ...
      <Section title="Epidemiologia">
        ...
        <P>
          Estima-se que, no Brasil, existam aproximadamente 20 milhões de
      ...
      <Section title="Manejo das Crises Agudas (exacerbações) de Asma">
        ...
        <P>
          ...
          progressiva em um período de 5-7 dias. As exacerbações da Asma podem
          ser: muito graves, graves ou leves a moderadas. Exacerbações muito
          graves são eventos que requerem uma ação urgente do médico e do
          paciente para prevenir um desfecho de morte por causa da asma. O
          tratamento em UTI é recomendado.
        </P>
        <P>
        ...
        <Subsection title="Importante">
          <P>
            ...
            Pulso para determinação da SpO<Subscript>2</Subscript>. A gasometria
            arterial com determinação da PaO<Subscript>2</Subscript> e PCO
            <Subscript>2</Subscript> pode ser necessária em casos graves. Já o
            PFE pode ser utilizado, se disponível.
          </P>
        </Subsection>
      </Section>
      <Section title="Manejo do Paciente com Crise Leve a Moderada">
        ...
        <P>
          ...
          curta duração com espaçador e máscara (SABA) e corticosteróide
          sistêmico por via oral por um período determinado de 5 a 7 dias (
        ...
        <P>
          ...
          associado à dose de ataque de corticosteróide sistêmico por via oral.
        </P>
      </Section>
      <Section title="Manejo do Paciente com Crise Grave">
        <P>
          O paciente asmático com crise grave chega à emergência com dispneia
          moderada <Bold>a importante</Bold>, com retrações musculares
          acentuadas e com baixa saturação, frequentemente abaixo de 92%.
        </P>
        <P>
          O paciente com estas características ainda <Bold>NÃO ENTROU</Bold> em
          insuficiência respiratória, porém trata-se de um paciente de risco
          para tal condição grave, sendo necessária abordagem o mais precoce
        ...
        <P>
          ...
          vômitos), dose de ataque de corticosteróide IV ou VO e,{' '}
          <Bold>em alguns casos mais graves</Bold>, <Bold>Adrenalina</Bold> (até
          2 doses com intervalo de 10 minutos).
        </P>
      </Section>
      <Section title="Dieta">
        <P>
      ...
      <Section title="Oxigenoterapia">
        <P>
          O oxigênio suplementar está indicado para pacientes com SatO
          <Subscript>2</Subscript> {'<'}
          92%. Alguns poucos pacientes respondem bem à terapia de resgate (veja
        ...
        <P>
          ...
          com crise aguda grave de asma é que o mesmo é feito de forma{' '}
          <Bold>NÃO INVASIVA</Bold>, utilizando-se um dos métodos abaixo:
        </P>
        <Subsection title="Oxigênio Umidificado Sob Cateter Nasal">
          <P>
            ...
            de O<Subscript>2</Subscript>. É relativamente simples e permite que
            o paciente converse e alimente-se, sem interrupção de O
            <Subscript>2</Subscript>. Recomenda-se um fluxo máximo de 3l/min.
            Feito por catéter próprio que possui vários "furinhos" em sua
            extremidade. Este dispositivo deveria atingir a úvula. No entanto,
            sua inserção geralmente se faz às cegas até uma profundidade igual à
            distância entre o nariz e o lóbulo da orelha. Como este catéter
            ...
            conforme a quantidade de fluxo de oxigênio fornecido por minuto, o
            tamanho dos seios da face e a frequência e volume respiratório do
            paciente.
          </P>
          <P>
            <Bold>Vantagens:</Bold> Método econômico e que utiliza dispositivos
            simples; Facilidade de aplicação.
          </P>
          <P>
            <Bold>Desvantagens:</Bold> Nem sempre é bem tolerado em crianças em
            função do desconforto produzido (mais que a cânula nasal); A
            respiração bucal diminui a fração inspirada de O
            <Subscript>2</Subscript>; Irritabilidade tecidual da via aérea;
            Possibilidade de trauma em adenoide; Facilidade no deslocamento do
            cateter; Não permite nebulização.
          </P>
        </Subsection>
        <Subsection title="Oxigênio umidificado sob Cânula Nasal">
          <P>
            ...
            de O<Subscript>2</Subscript>. É relativamente simples e permite que
            o paciente converse e alimente-se, sem interrupção de O
            <Subscript>2</Subscript>. Recomenda-se um fluxo máximo de 3l/min e é
            o método mais empregado nos pacientes pediátricos com crise aguda
            grave. Consiste em um sistema de fornecimento de Oxigênio por cânula
          ...
          <P>
            <Bold>Desvantagens:</Bold> Nem sempre é bem tolerado em crianças em
            função do desconforto produzido; A respiração bucal diminui a fração
            inspirada de O<Subscript>2</Subscript>; Irritabilidade tecidual da
            nasofaringe; Ressecamento das narinas; Facilidade no deslocamento do
            cateter; Não permite uma adequada nebulização.
          </P>
        </Subsection>
      </Section>
      <Section title="Máscara Facial Simples (sem reservatório)">
        ...
        <P>
          <Bold>Desvantagens:</Bold> A concentração real liberada de O
          <Subscript>2</Subscript> varia com o padrão respiratório; É necessário
          um fluxo mínimo de 5 l/min de O<Subscript>2</Subscript> para evitar
          que o paciente reinale o CO<Subscript>2</Subscript> expirado contido
          no reservatório; Dificulta a expectoração; Cobre a boca e o nariz,
          pode produzir claustrofobia; Difícil aplicação em pacientes com sondas
          naso ou orotraqueais ou pacientes com lesões e traumas de face.
        </P>
      </Section>
      <Section title="Máscara de Venturi (sem reservatório)">
        <P>
          Método empregado quando o paciente requer uma concentração moderada ou
          alta de O2. Possibilita um controle da fração inspirada de O
          <Subscript>2</Subscript> (FiO
          <Subscript>2</Subscript>) fornecida ao paciente. Neste item, a
          codificação da FiO<Subscript>2</Subscript> fornecida ao sistema é
          realizada por meio de válvulas plásticas de cores diferentes, de
          acordo com a quantidade de oxigênio que elas liberam em litros por
          minuto. Fornece uma concentração de oxigênio de 24% a 50%. O fluxo
          geralmente utilizado é de 4 a 12 litros por minuto, conectada
          diretamente a rede de O<Subscript>2</Subscript>. Com umidificador,
          usa-se 15l/min. Possui um sistema de válvulas para diferentes
          concentrações de FiO<Subscript>2</Subscript>.
        </P>
        <Table
          ...
          header={[
            ...
            'Cores',
            <Text key={1}>
              FiO<Subscript>2</Subscript>(%)
            </Text>,
            <Text key={2}>
              Fluxo de O<Subscript>2</Subscript> (l/min)
            </Text>
          ]}
          data={[
            ['1', 'Azul', '24', '4'],
        ...
        />
        <P>
          <Bold>Vantagens:</Bold> É leve e bem tolerada pelo paciente; protege
          contra dosagens nocivas de oxigênio.
        </P>
        <P>
          <Bold>Desvantagens:</Bold> Desloca-se facilmente; dificulta a fala;
      ...
      <Section title="Máscaras com Reservatório">
        <P>
          ...
          <Subscript>2</Subscript>. As máscaras de REINALAÇÃO PARCIAL e
          NÃO-REINALAÇÃO possuem uma bolsa reservatório flexível de 1 litro
          fixada à entrada de oxigênio, produzindo FiO
          <Subscript>2</Subscript> mais elevada que a máscara simples. A
          diferença fundamental entre estes dois modelos de máscaras é o
          dispositivo de válvulas.
        </P>
        <P>
          A máscara de <Bold>reinalação parcial</Bold> não contém válvulas.
          Durante a inspiração, o oxigênio flui para o interior da máscara e
          passa diretamente ao paciente e durante a expiração parte do ar é
          armazenado na bolsa. Como não existe válvula separando a máscara da
          bolsa, parte do gás expirado pelo paciente também entra nesta, o que
          não acontece com as máscaras que possuem válvulas. Como a porção
          inicial do gás expirado é oriunda do espaço morto anatômico, a bolsa
          possui, sobretudo, oxigênio e pouco CO
          <Subscript>2</Subscript>. À medida que a bolsa se enche de oxigênio e
          gás do espaço morto, dois terços finais da expiração escapam através
          das portas de expiração da máscara. Enquanto o fluxo de entrada de
          oxigênio evita o colapso da bolsa durante a inspiração, a reinalação
          de CO<Subscript>2</Subscript> se torna desprezível.
        </P>
        <P>
          A máscara de <Bold>não-reinalação</Bold> impede a reinalação através
          de válvulas unidirecionais. Uma válvula inspiratória se encontra no
          topo da bolsa, enquanto as válvulas expiratórias cobrem as portas de
          expiração sobre o corpo da máscara. Durante a inspiração, uma leve
          pressão negativa fecha as válvulas expiratórias, impedindo a diluição
          aérea; ao mesmo tempo, a válvula inspiratória localizada no topo da
          bolsa se abre fornecendo oxigênio ao paciente. Durante a expiração, a
          ação da válvula reverte a direção do fluxo; uma pressão positiva
          discreta fecha a válvula inspiratória, impedindo que o gás expirado
          entre na bolsa. Concomitantemente, as válvulas expiratórias
          unidirecionais se abrem e desviam o gás expirado para a atmosfera.
        </P>
      </Section>
      <Section title="Monitorização">
        <P>
          ...
          <Subscript>2</Subscript>, FR e FC pelo médico assistente. Dependendo
          da disponibilidade e da condição clínica, a monitorização pode ser
          contínua, por meio de aparelhos eletrônicos não invasivos.
        </P>
      </Section>
      <Section title="Manejo medicamentoso Inicial na Emergência">
        ...
        <List>
          ...
          <LItem>
            Corticosteróide (preferência VO), numa dose de ataque (
            <Bold>vide lista de medicações no fim da rotina</Bold>
            ).
          </LItem>
        </List>
      ...
      <Section title="Manejo da criança internada na Emergência/Enfermaria">
        <P>
          ...
          moderado e/ou baixa SpO<Subscript>2</Subscript> possui indicação de
          internação. A partir daí, considera-se todos os comemorativos citados
          anteriormente no manejo, de acordo com as regras desta rotina (Dieta,
          Hidratação Venosa, Oxigenoterapia).
        </P>
        <P>
          Em relação à terapia medicamentosa, a indicação usual consiste na
          utilização do SABA e corticosteróide em doses programadas, conforme a
          seguir:
        </P>
        <List>
          <LItem>
            ...
            AUSENTE e boa SpO2 podem usar o SABA em doses menores (cerca de 20%
          ...
          <LItem>
            2. Corticosteróide nas doses preconizadas. Dá-se preferência ao VO,
        ...
        <List>
          ...
          <LItem>Corticosteróide (preferência VO, se possível);</LItem>
          <LItem>
        ...
        <P>
          ...
          outros medicamentos para evitar a internação em UTI. São eles:
        </P>
        <Subsection title="Adrenalina">
          <P>
            ...
            terapêutica heróica em pacientes jovens (idade menor que 40 anos) em
            ...
            emergência com risco de insuficiência respiratória, a administração
            da adrenalina deve ser feita por via SC ou IM. Pacientes que
            entraram em insuficiência respiratória (crise aguda muito grave), a
            via IV deve ser a escolhida.
          </P>
        </Subsection>
        ...
        <Subsection title="Sulfato de Magnésio">
          <P>
            Ainda não foi definido o mecanismo exato da ação do MgSO
            <Subscript>4</Subscript> , porém existem algumas proposições . É um
            antagonista fisiológico natural do cálcio regulando seu acesso para
            o espaço intracelular no músculo liso, promovendo broncodilatação. O
            mecanismo é competitivo e exerce seu efeito no canal de cálcio tipo
            L16. Também exerce efeito inibitório na enzima Ca-ATPase. Exerce
            efeito de relaxamento muscular por inibição da liberação de
            acetilcolina na junção neuromuscular. A hipermagnesemia diminui a
            sensibilidade da placa motora à acetilcolina, bem como a amplitude
            do potencial de placa terminal. É um antagonista do receptor NMDA do
            glutamato que lhe confere propriedades analgésicas,
            anticonvulsivantes e sedativas. O magnésio pode aumentar a síntese
            de prostaciclinas e inibir a enzima conversora de angiotensina.
            Inibição da liberação de histamina pelos mastócitos e estimulação da
            produção de óxido nítrico. Resumindo, é{' '}
            <Bold>
          ...
          <P>
            Quando favorável, a resposta terapêutica ocorre em 1-2 h após a
            infusão. Pode ser considerada uma terapêutica segura. Seus
            principais efeitos adversos são rubor cutâneo e náuseas, geralmente
            durante a infusão. Fraqueza, arreflexia e depressão respiratória
            podem potencialmente ocorrer, mas com níveis séricos da droga muito
            elevados ({'>'} 12 mg/dL). Trata-se de uma medicação que não se deve
            prescrever de horário, sendo necessárias avaliações clínicas
            periódicas para prescrição de cada dose da medicação (
            <Bold>vide lista de medicações no fim da rotina</Bold>
            ).
          </P>
        </Subsection>
        <Subsection title="Xantinas">
          <P>
            A <Bold>aminofilina</Bold> já foi considerada a arma terapêutica
            fundamental no manejo da crise de asma aguda grave e muito grave,
            porém, perdeu gradualmente essa posição de destaque, principalmente
            pela grande proximidade da dose terapêutica com a dose tóxica
            (estreita faixa terapêutica). Deve-se dar atenção para a alta
            frequência de interações medicamentosas e para os efeitos adversos
        ...
        <Subsection title="Salbutamol Venoso">
          <P>
            ...
            hipopotassemia, exigindo monitorização contínua da SpO
            <Subscript>2</Subscript> e dosagens frequentes do Potássio sérico.
            Lembrar-se de suspender o SABA inalatório quando se prescrever doses
            IV.
          </P>
        </Subsection>
      </Section>
      <Section title="Manejo do Paciente com Crise Muito Grave">
        <P>
          ...
          respiratória, exigindo medidas imediatas como: dieta zero, acesso
          venoso e hidratação venosa, uso de corticosteróide IV pela intensidade
          do desconforto respiratório, uso de salbutamol IV e demais medicações
          de uso venoso, como é o caso do sulfato de magnésio ou xantinas.
      ...
      <Section title="Critérios de Alta Hospitalar e Acompanhamento">
        ...
        <List>
          <LItem>
            Que o paciente esteja em <Bold>ar ambiente</Bold> por pelo menos 24
            horas (lactentes) ou 4-6 horas (maiores de 2 anos):
          </LItem>
          <List>
            <LItem>Dispneia ausente ou leve;</LItem>
            <LItem>Taquipneia ausente ou leve;</LItem>
            <LItem>
              SpO<Subscript>2</Subscript> {'>'}92%.
            </LItem>
          </List>
          <LItem>
          ...
          <List>
            ...
            <LItem>
              Corticosteróide sistêmico por via oral, completando-se 7 dias de
              tratamento total (somar ao tempo de corticosteróide usado durante
        ...
        <P>
          Todos os pacientes internados por crise de asma, independente de sua
          intensidade, têm indicação de <Bold>acompanhamento ambulatorial</Bold>
          .
        </P>
      </Section>
      <Section title="Medicações Tratamento Crise Aguda de Asma em Criança">
        ...
        <P>Dose:</P>
        <P>
          <Bold>Adrenalina PURA (1:1000):</Bold> 0,01ml/Kg (máximo 0,3ml) - Uso
          SC ou IM.
        </P>
        <P>
          <Bold>Adrenalina DILUÍDA (1:10.000):</Bold> 0,1ml/Kg (máximo 3 ml) -
          Uso SC, IM ou IV.
        </P>
      </Section>
      ...
      <Section title="Corticosteróide de Ação Sistêmica">
        <Table
          ...
          data={[
            [
              'Prednisolona ou Prednisona - VO (Máximo 60 mg)',
              '1 - 2 mg/kg',
        ...
        <Subsection title="Salbutamol Venoso 500mcg ou 0,5mg/ml">
          ...
          <P>
            Dose de manutenção: 0,2 - 0,8 mcg/kg/min (pode ir aumentando a dose
            a cada 30min);
          </P>
        ...
        <Subsection title="Sulfato de Magnésio 50% Injetável (500mg/ml)">
          <P>
            Dose: Crianças: 25 a 50 mg/kg, IV ou IM, a cada 4 a 6 horas. Dose
            máxima: 2g.{' '}
            <Bold>
