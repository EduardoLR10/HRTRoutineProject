...
export default [
  ...
  new Author(
    'manuela',
    'Manuela de O. Fragomeni',
    Manuela,
    'http://lattes.cnpq.br/5590230320617326'
  ),
  new Author(
    'marco',
    'Marco Antônio A. Cunha',
    Marco,
