    ...
    static authors = "Dr. Marco Antônio Alves Cunha"
        ...
        <Routine title={DengueEOutrasArboviroses.title} category={DengueEOutrasArboviroses.category} authors={DengueEOutrasArboviroses.authors}>
            ...
            <Reference idx={2} authors="Singhi S, Kissoon N, Bansal A." title="Dengue e dengue hemorrágico: aspectos do manejo na unidade de terapia intensiva (83(2 Suppl):S22-35)." local="J Pediatr (Rio J)." year="2007"/>
