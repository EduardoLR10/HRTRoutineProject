    ...
    render = () =>
      <Routine title={ConceitosBasicosDeVentilacaoMecanica.title} category={ConceitosBasicosDeVentilacaoMecanica.category} authors={ConceitosBasicosDeVentilacaoMecanica.authors}>
        ...
        <Section title="Fisiologia Ventilatória em Pulmões Sadios">
            ...
            <P>
                Dessa forma, quando selecionamos no ventilador mecânico o modo controlado a pressão, por exemplo, o pico de pressão inspiratória deve ser estabelecido a fim de gerar volumes correntes dentro do mesmo intervalo (6 a 8 mL/kg), controlando a pressão de pico (PI) que oscila aproximadamente entre 15 e  20 cmH<P style={{fontSize: 6}}>2</P>O.
            </P>
            <P>
        ...
        <Section title="Situações Clínicas de Interesse">
            ...
            <Subsection title="Hipercapnia Permissiva">
                <P>
                    A hipercapnia permissiva pode ser definida como a presença de uma elevada PaCO<P style={{fontSize: 6}}>2</P>, sem que haja uma alteração muito significante do pH (7,2 – 7,3). A longo prazo a lesão e remodelação pulmonar será menor diante dessa condição.
                </P>
            </Subsection>
