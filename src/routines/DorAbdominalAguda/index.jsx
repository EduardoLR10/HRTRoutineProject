...
export default class DorAbdominalAguda extends React.Component {
    ...
    render = () =>
      <Routine title={DorAbdominalAguda.title} category={DorAbdominalAguda.category} authors={DorAbdominalAguda.authors}>
          ...
          <Section title="Tratamento">
            ...
            <Figure source={img1}/>
            <Figure source={img2} bottom_label="Figura 1. Fluxograma de investigação etiológica do paciente pediátrico com dor."/>
          </Section>
        <Section title="Referências">
        <Reference idx={1} body="CARVALHO E, Ferreira CT, Silva LR. Gastroenterologia e nutrição em pediatria. Barueri, SP: Manole, 2012."/>
        <Reference idx={2} body="TOPOROVSKI MS. Avaliação clínica da dor abdominal aguda. Recomendações.  Atualização de Condutas em Pediatria. Departamentos Científicos da SPSP, nº 43 gestão 2007-2009. Disponível em: http://www.spsp.org.br/site/asp/recomendacoes/Rec_43_DorAbdominal.pdf "/>
        <Reference idx={3} body="CARVALHO MCM, et al. Manual de protocolos terapêuticos em pediatria 1ª edição. Ministério da Saúde. 2010. Disponível em: https://www.minsaude.gov.cv/index.php/documentosite/outros-documentos/manuais/200-manual-protocolos-pediatria/file"/>
        </Section>
    </Routine>
}